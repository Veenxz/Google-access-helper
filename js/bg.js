...
define("app/p", [], function(t, e) {
    ...
    var m = function(t, e) {
      ...
      , w = function(t, e) {
        return localStorage["stop-proxy"] && "true" == localStorage["stop-proxy"] ? (s.off("", "学习资料已经暂停，点击启动运行"),
        void chrome.proxy.settings.set({
            ...
            console.info("- proxy system! - ")
        })) : Date.now() - h > 1728e5 ? (s.off("!", "<br>需要重启浏览器才能重新使用"),
        console.log("expired"),
        void chrome.proxy.settings.set({
            value: {
                mode: "system"
...
seajs.use(["app/u", "lib/t", "app/t", "app/p", "app/b", "app/notifications", "app/mainServer"], function(t, e, n, r, o, i, a) {
    ...
    a.get(function() {
        n.D(),
        n.R(function() {
            localStorage["auto-homepage"] && "false" == localStorage["auto-homepage"] && chrome.tabs.query({}, function(t) {
